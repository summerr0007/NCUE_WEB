...
<script src="js/datatable_reviews.js"></script>
...
<body>
    ...
    <?php include "left_side_admin.php"; ?>
        <div class="col-lg-10 text-center">
            <form class="form-horizontal form-inline" name="form_reviews" id="form_reviews" method="POST">
